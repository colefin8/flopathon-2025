...
<template>
  ...
  <div class="volume-app-wrapper">
    ...
    <div class="volume-input-card" :style="{ transform: cardTransform }" @mousemove="handleMouseMove"
      ...
      <div class="dial-pad">
        ...
        <div v-for="key in dialPadKeys" :key="key.number" class="dial-pad-key" @click="handleDial(key.number)">
...
@keyframes cardPulse {
  ...
  0% {
    box-shadow: 0 0 40px rgba(0, 255, 255, 0.6), inset 0 0 20px rgba(0, 255, 255, 0.3);
    filter: brightness(1);
  }

  50% {
    box-shadow: 0 0 55px rgba(0, 255, 255, 0.8), inset 0 0 25px rgba(0, 255, 255, 0.4);
...
@keyframes textGlitch {
  ...
  0% {
    text-shadow: 0 0 10px rgba(0, 255, 255, 0.7), 2px 2px 0px rgba(255, 0, 0, 0.5);
    transform: translateX(0px);
  }

  20% {
    text-shadow: 0 0 10px rgba(0, 255, 255, 0.7), -2px -2px 0px rgba(0, 255, 0, 0.5);
    transform: translateX(1px);
  }

  40% {
    text-shadow: 0 0 10px rgba(0, 255, 255, 0.7), 1px 1px 0px rgba(0, 0, 255, 0.5);
    transform: translateX(-1px);
  }

  60% {
    text-shadow: 0 0 10px rgba(0, 255, 255, 0.7), -1px 1px 0px rgba(255, 255, 0, 0.5);
    transform: translateX(0.5px);
  }

  80% {
    text-shadow: 0 0 10px rgba(0, 255, 255, 0.7), 2px -2px 0px rgba(255, 0, 255, 0.5);
    transform: translateX(-0.5px);
  }
...
.volume-app-wrapper {
  ...
  z-index: 1;
  /* Ensure container is above grid */

  /* Add top margin to push it below the fixed header */

  margin-top: 70px;
  /* Adjust this value based on your header's height (60px) + desired spacing */
  ...
  position: relative;
  /* For scanline pseudo-element */

  min-height: calc(100vh - 90px);
  /* Ensure wrapper takes up remaining height, considering header and margin */
...
.volume-app-wrapper::before {
  ...
  position: absolute;
  /* Changed from fixed to absolute to stay within wrapper */
  ...
  animation: scanlineFlicker 0.1s infinite alternate, globalFlicker 2s infinite step-end;
  /* Faster flicker, global flicker */
...
.hud-background-grid {
  ...
  position: absolute;
  /* Changed to absolute to stay within wrapper */
...
.hud-background-grid::before {
  ...
  /* Smaller grid cells for second layer */
...
.volume-input-card {
  ...
  background: linear-gradient(135deg, rgba(10, 25, 40, 0.85) 0%, rgba(15, 35, 55, 0.85) 100%);
  /* Deeper gradient */
  ...
  border-image: linear-gradient(45deg, #00ffff, #007bff, #00ffff) 1;
  /* Gradient border */
...
.title {
  ...
  animation: textGlitch 0.2s infinite alternate steps(2);
  /* Faster text glitch */
...
.current-volume {
  ...
  color: #76ff03;
  /* Bright lime green for active info */

  text-shadow: 0 0 8px rgba(118, 255, 3, 0.8);

  animation: textGlitch 0.3s infinite alternate steps(3);
  /* Faster text glitch */
...
.input-display {
  ...
  animation: inputPulse 3s infinite ease-in-out, textGlitch 0.25s infinite alternate steps(2);
  /* Pulsing effect for input + text glitch */
...
.dial-pad-key {
  ...
  background: linear-gradient(135deg, rgba(0, 255, 255, 0.08) 0%, rgba(0, 191, 255, 0.08) 100%);
...
.dial-pad-key:hover {
  ...
  box-shadow: 0 0 35px rgba(0, 255, 255, 0.8), inset 0 0 18px rgba(0, 255, 255, 0.5);
  /* Intense hover glow */
...
.dial-pad-key.call-button .number {
  ...
  font-size: 1.8em;
  /* Adjusted "Call" font size to be more prominent but fit */
...
.message-area {
  ...
  height: 60px;
  /* Slightly taller fixed height for messages */
...
.message {
  ...
  /* Stronger message text glow */

  animation: messageFadeIn 0.5s ease-out, messagePulse 1.5s infinite alternate, messageGlitch 0.15s infinite alternate steps(2);
  /* Pulsing message + faster glitch */
